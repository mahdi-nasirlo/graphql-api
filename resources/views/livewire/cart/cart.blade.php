            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol
                        ...
                        <li class="breadcrumb-item text-nowrap"><a href={{ route('home') }}">فروشگاه</a>
                        </li>
        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
                    <h2 class="h6 text-light mb-0">محصولات</h2><a class="btn btn-outline-primary btn-sm ps-2"
                        href="shop-grid-ls.html"><i class="ci-arrow-left me-2"></i>ادامه خرید</a>
                </div>
                <!-- Item-->
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="img/shop/cart/01.jpg" width="160" alt="محصول"></a>
                        <div class="pt-2">
                            <h3 class="product-title fs-base mb-2"><a href="shop-single-v1.html">کفش کتانی</a></h3>
                            <div class="fs-sm"><span class="text-muted me-2">سایز : </span>8.5</div>
                            <div class="fs-sm"><span class="text-muted me-2">رنگ:</span>سفید و آبی</div>
                    ...
                    <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
                        ...
                        <button class="btn btn-link px-0 text-danger" type="button"><i
                                class="ci-close-circle me-2"></i><span class="fs-sm">حذف</span></button>
                    </div>
                </div>
                <!-- Item-->
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="img/shop/cart/02.jpg" width="160" alt="محصول"></a>
                        <div class="pt-2">
                            <h3 class="product-title fs-base mb-2"><a href="shop-single-v1.html">کفش کتانی</a></h3>
                            <div class="fs-sm"><span class="text-muted me-2">برند : </span>تامی</div>
                            <div class="fs-sm"><span class="text-muted me-2">رنگ:</span>خاکی</div>
                            <div class="fs-lg text-accent pt-2">79.<small>50</small></div>
                        </div>
                    </div>
                    <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
                        style="max-width: 9rem;">
                        <label class="form-label" for="quantity2">تعداد</label>
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="img/shop/cart/03.jpg" width="160" alt="محصول"></a>
                        <div class="pt-2">
                            <h3 class="product-title fs-base mb-2"><a href="shop-single-v1.html">کفش کتانی</a></h3>
                            <div class="fs-sm"><span class="text-muted me-2">برند : </span>تامی</div>
                            <div class="fs-sm"><span class="text-muted me-2">رنگ:</span>آبی</div>
                            <div class="fs-lg text-accent pt-2">22.<small>50</small></div>
                        </div>
                    </div>
                    <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
                        style="max-width: 9rem;">
                        <label class="form-label" for="quantity3">تعداد</label>
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a
                            class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img
                                src="img/shop/cart/04.jpg" width="160" alt="محصول"></a>
                        <div class="pt-2">
                            <h3 class="product-title fs-base mb-2"><a href="shop-single-v1.html">کفش کتانی</a></h3>
                            <div class="fs-sm"><span class="text-muted me-2">سایز : </span>42</div>
                            <div class="fs-sm"><span class="text-muted me-2">رنگ:</span>آبی</div>
                    ...
                    <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
                        style="max-width: 9rem;">
                        <label class="form-label" for="quantity4">تعداد</label>
                ...
                <button class="btn btn-outline-accent d-block w-100 mt-4" type="button"><i
                        class="ci-loading fs-base me-2"></i>به روز رسانی</button>
            </section>
            <!-- Sidebar-->
                ...
                <div class="bg-white rounded-3 shadow-lg p-4">
                    <div class="py-2 px-xl-2">
                        <div class="text-center mb-4 pb-3 border-bottom">
                            ...
                            <h3 class="fw-normal">2560<small>00</small></h3>
                        </div>
                        <div class="mb-3 mb-4">
                        ...
                        <div class="accordion" id="order-options">
                            <div class="accordion-item">
                                <h3 class="accordion-header"><a class="accordion-button" href="#promo-code"
                                        ...
                                        aria-controls="promo-code">اعمال کد </a></h3>
                                <div class="accordion-collapse collapse show" id="promo-code"
                                    ...
                                    <form class="accordion-body needs-validation" method="post" novalidate="">
                                        <div class="mb-3">
                                            <input class="form-control" type="text" placeholder="کد تخفیف"
                                                required="">
                                            <div class="invalid-feedback">کد تخفیف را وارد کنید</div>
                                        </div>
                                        <button class="btn btn-outline-primary d-block w-100" type="submit">اعمال کد
                                        </button>
                                    </form>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h3 class="accordion-header"><a class="accordion-button collapsed"
                                        ...
                                        aria-expanded="true" aria-controls="shipping-estimates">تخمین حمل و نقل</a>
                                </h3>
                                <div class="accordion-collapse collapse" id="shipping-estimates"
                                    ...
                                    <div class="accordion-body">
                                        <form class="needs-validation" novalidate="">
                                            ...
                                            <button class="btn btn-outline-primary d-block w-100" type="submit">حمل و
                                                نقل را محاسبه کنید</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        </div><a class="btn btn-primary btn-shadow d-block w-100 mt-4"
                            href="{{ route('cart.detail') }}"><i class="ci-card fs-lg me-2"></i>ادامه بررسی</a>
                    </div>
                </div>
            </aside>
        </div>
