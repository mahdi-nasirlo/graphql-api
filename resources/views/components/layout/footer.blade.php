        ...
        <div class="row pb-2">
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-links widget-light pb-2 mb-4">
                    ...
                    <ul class="widget-list">
                        <li class="widget-list-item"><a class="widget-list-link" href="#">کفش های
                                کتانی و ورزشی</a></li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">لباس
                                ورزشی</a></li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">لباس
                                ورزشی</a></li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">لباس
            ...
            <div class="col-md-4 col-sm-6">
                <div class="widget widget-links widget-light pb-2 mb-4">
                    ...
                    <ul class="widget-list">
                        <li class="widget-list-item"><a class="widget-list-link" href="#">حساب</a>
                        </li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">نرخ حمل و
                                نقل </a></li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">بازپرداخت
                                و جایگزینی</a></li>
                        ...
                        <li class="widget-list-item"><a class="widget-list-link" href="#">اطلاعات
                                تحویل</a></li>
                        <li class="widget-list-item"><a class="widget-list-link" href="#">مالیات و
                                هزینه ها</a></li>
                    </ul>
                </div>
                <div class="widget widget-links widget-light pb-2 mb-4">
                    ...
                    <ul class="widget-list">
                        ...
                        <li class="widget-list-item"><a class="widget-list-link" href="#">مشاغل</a>
                        </li>
            ...
            <div class="col-md-4">
                <div class="widget pb-2 mb-4">
                    ...
                    <form class="subscription-form validate" action="#" method="post"
                        ...
                        <div class="form-text text-light opacity-50">* برای دریافت پیشنهادات تخفیف ، به
                            روزرسانی و اطلاعات جدید محصولات ، در خبرنامه ما مشترک شوید.</div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex"><i class="ci-rocket text-primary" style="font-size: 2.25rem;"></i>
                        <div class="ps-3">
                            ...
                            <p class="mb-0 fs-ms text-light opacity-50">ارسال رایگان برای کلیه سفارش های بالای
                                200 </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pb-2">
                        ...
                        <div class="btn-group dropdown disable-autohide">
                            ...
                            <ul class="dropdown-menu my-1">
                                ...
                                <li><a class="dropdown-item pb-1" href="#"><img class="me-2"
                                            src="img/flags/fr.png" width="20"
                                            alt="فرانسه">فرانسه</a></li>
                                <li><a class="dropdown-item pb-1" href="#"><img class="me-2"
                                            src="img/flags/de.png" width="20" alt="آلمان">آلمان</a>
                                </li>
                                <li><a class="dropdown-item" href="#"><img class="me-2"
                                            src="img/flags/it.png" width="20"
                                            alt="ایتالیا">ایتالیا</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="widget widget-links widget-light">
                        <ul
                            ...
                            <li class="widget-list-item me-4"><a class="widget-list-link"
                                    href="#">خروجی ها</a></li>
                            <li class="widget-list-item me-4"><a class="widget-list-link"
                                    href="#">شرکت های وابسته</a></li>
                            <li class="widget-list-item me-4"><a class="widget-list-link"
                                    href="#">پشتیبانی</a></li>
                            <li class="widget-list-item me-4"><a class="widget-list-link"
                                    href="#">شرایط</a></li>
                            <li class="widget-list-item me-4"><a class="widget-list-link"
                                    href="#">شرایط استفاده</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 text-center text-md-end mb-4">
                    <div class="mb-3"><a class="btn-social bs-light bs-twitter ms-2 mb-2"
                            ...
                            class="btn-social bs-light bs-facebook ms-2 mb-2" href="#"><i
