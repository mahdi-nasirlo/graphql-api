                                        ...
                                        <div class="widget-cart-item py-2 border-bottom">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-2">
                                                    ...
                                                    <div class="widget-product-meta">
                                                        <span class="text-accent me-2">799.<small>00</small></span><span
                                                            class="text-muted">x
                                                            1</span>
                                                    </div>
                                                </div>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown position-static mb-0"><a
                                            class="dropdown-item border-bottom py-2" href="home-nft.html"><span
                                                class="d-block text-heading">بازار
                                    ...
                                    <li class="dropdown position-static mb-0"><a
                                            ...
                                            href="home-fashion-store-v1.html"><span
                                                class="d-block text-heading">فروشگاه
                                    ...
                                    <li class="dropdown position-static mb-0"><a
                                            ...
                                            href="home-grocery-store.html"><span
                                                ...
                                                صفحه+منو</small></a>
                                        <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                            <a class="d-block" href="home-grocery-store.html"
                                    ...
                                    <li class="dropdown position-static mb-0"><a
                                            ...
                                            href="home-food-delivery.html"><span class="d-block text-heading">خدمات
                                                ...
                                                نوشیدنی</small></a>
                                        <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                            <a class="d-block" href="home-food-delivery.html"
                                                style="width: 250px;"><img src="img/home/preview/th07.jpg"
                                                    alt="خدمات تحویل غذا"></a>
                                        </div>
                                    </li>
                                    <li class="dropdown position-static mb-0"><a
                                            class="dropdown-item py-2 border-bottom"
                                    ...
                                    <li class="dropdown position-static mb-0"><a class="dropdown-item py-2"
                                            href="home-single-store.html"><span class="d-block text-heading">فروشگاه
                                                ...
                                                محصول/مارک</small></a>
                                        <div class="dropdown-menu h-100 animation-none mt-0 p-3">
                                            <a class="d-block" href="home-single-store.html"
                                        ...
                                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                                                ...
                                                <ul class="widget-list">
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="shop-grid-ls.html">فروشگاه-نوار
                                                            سمت
                                                            راست</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="shop-grid-rs.html">فروشگاه-نوار
                                                            سمت
                                                            چپ</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="shop-grid-ft.html">فروشگاه-فیلتر
                                                            بالا</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                            ...
                                            <div class="widget widget-links mb-4">
                                                ...
                                                <ul class="widget-list">
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="marketplace-category.html">دسته
                                                            بندی</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                            ...
                                            <div class="widget widget-links">
                                                ...
                                                <ul class="widget-list">
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="grocery-catalog.html">کاتالوگ
                                                            محصول</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                                    ...
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="grocery-checkout.html">بررسی</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                                            <div class="widget widget-links mb-4">
                                                ...
                                                <ul class="widget-list">
                                                    ...
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="food-delivery-single.html">تک
                                                            کالا(رستوران)</a>
                                                    </li>
                                                    <li class="widget-list-item">
                                            ...
                                            <div class="widget widget-links">
                                                ...
                                                <ul class="widget-list">
                                                    ...
                                                    <li class="widget-list-item">
                                                        <a class="widget-list-link"
                                                            href="nft-single-auction-live.html">تک
                                                            مورد
                                                            -
                                                            حراج</a>
                                                    </li>
                                    ...
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="nft-account-favorites.html">علاقه
                                                    مندی </a></li>
                                            <li><a class="dropdown-item"
                                                    href="nft-account-notifications.html">اعلانات</a>
                                            </li>
                                        </ul>
                                    </li>
