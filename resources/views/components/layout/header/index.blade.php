                                            ...
                                            <div class="d-flex align-items-center"><a class="d-block flex-shrink-0"
                                                ...
                                                <div class="ps-2">
                                                    <h6 class="widget-product-title"><a
                                                            href="shop-single-v2.html">هدفون</a></h6>
                        ...
                        <ul class="navbar-nav">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown position-static mb-0"><a
                                        ...
                                        <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                                href="home-electronics-store.html" style="width: 250px;"><img
                                                    src="img/home/preview/th03.jpg" alt="فروشگاه الکترونیکی"></a>
                                        </div>
                                    </li>
                                    <li class="dropdown position-static mb-0"><a
                                            class="dropdown-item py-2 border-bottom"
                                    ...
                                    <li class="dropdown position-static mb-0"><a
                                            ...
                                            href="home-food-delivery.html"><span class="d-block text-heading">خدمات
                                                تحویل غذا</span><small class="d-block text-muted">تحویل غذا و
                                                نوشیدنی</small></a>
                                        <div class="dropdown-menu h-100 animation-none mt-0 p-3"><a class="d-block"
                                            ...
                                            <div class="widget widget-links mb-4">
                                                ...
                                                <ul class="widget-list">
                                                    <li class="widget-list-item"><a class="widget-list-link"
                                                            href="shop-grid-ls.html">فروشگاه-نوار سمت راست</a>
                                                    </li>
                                                    <li class="widget-list-item"><a class="widget-list-link"
                                                    ...
                                                    <li class="widget-list-item"><a class="widget-list-link"
                                                            href="shop-list-ls.html">لیست فروشگاه-منو راست</a>
                                                    </li>
                                                    <li class="widget-list-item"><a class="widget-list-link"
                                        ...
                                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                                            <div class="widget widget-links mb-4">
                                                ...
                                                <ul class="widget-list">
                                                    ...
                                                    <li class="widget-list-item"><a class="widget-list-link"
                                                            href="food-delivery-cart.html">سبد خرید(سفارش)</a>
                                                    </li>
                                                    <li class="widget-list-item"><a class="widget-list-link"
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="account-signin.html">ورود/ثبت نام</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#"
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="404-simple.html">متن ساده 404
                                                </a></li>
